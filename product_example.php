        ...
        <div class="content-content">
            ...
            <div class="comment">
                <div class="information">
                    ...
                    <p class="date">Февраль 12, 2021</p>
                </div>
                <p class="title">ПРЕКРАСНЫЙ МОДУЛЬ ДЛЯ ИЗМЕРЕНИЯ ОСВЕЩЁННОСТИ</p>
                <p class="text">Очень удобный модуль при работе в связке с приложением. Также он не обладает большим
                    весом.
                    За время эксплуатации минусов замечено не было.</p>
            </div>
